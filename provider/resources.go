...
const (
	...
	mainPkg = "duplocloud"
	// modules:
	mainMod = "index" // the duplocloud module
)

//go:embed cmd/pulumi-resource-duplocloud/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-duplocloud/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-duplocloud/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "duplocloud", duplocloud.Provider(),
		...
		// convention is to have a function at "github.com/duplocloud/terraform-provider-duplocloud/provider".New
	...
	prov.MustComputeTokens(tokens.SingleModule("duplocloud_", mainMod,

...
class AzureInfraSecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Specifies the name of the Key Vault Secret. Must start with the tenant's account name (case-insensitive); the Duplo backend filters list results by this prefix, so secrets without it cannot be retrieved after creation. Changing this forces a new resource to be created.

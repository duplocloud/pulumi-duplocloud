...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class AwsCloudfrontDistributionDefaultCacheBehaviorGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AwsCloudfrontDistributionDefaultCacheBehaviorForwardedValuesGetArgs>? ForwardedValues { get; set; }

        [Input("functionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionDefaultCacheBehaviorFunctionAssociationGetArgs>? _functionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionDefaultCacheBehaviorFunctionAssociationGetArgs> FunctionAssociations
        {
            get => _functionAssociations ?? (_functionAssociations = new InputList<Inputs.AwsCloudfrontDistributionDefaultCacheBehaviorFunctionAssociationGetArgs>());
            set => _functionAssociations = value;
        }

        [Input("lambdaFunctionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionDefaultCacheBehaviorLambdaFunctionAssociationGetArgs>? _lambdaFunctionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionDefaultCacheBehaviorLambdaFunctionAssociationGetArgs> LambdaFunctionAssociations
        {
            get => _lambdaFunctionAssociations ?? (_lambdaFunctionAssociations = new InputList<Inputs.AwsCloudfrontDistributionDefaultCacheBehaviorLambdaFunctionAssociationGetArgs>());
        ...
        public AwsCloudfrontDistributionDefaultCacheBehaviorGetArgs()
        {
        }
        public static new AwsCloudfrontDistributionDefaultCacheBehaviorGetArgs Empty => new AwsCloudfrontDistributionDefaultCacheBehaviorGetArgs();
    }
}

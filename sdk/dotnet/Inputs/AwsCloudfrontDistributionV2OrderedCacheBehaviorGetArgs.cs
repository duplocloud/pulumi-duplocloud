...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class AwsCloudfrontDistributionV2OrderedCacheBehaviorGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorForwardedValuesGetArgs>? ForwardedValues { get; set; }

        [Input("functionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorFunctionAssociationGetArgs>? _functionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorFunctionAssociationGetArgs> FunctionAssociations
        {
            get => _functionAssociations ?? (_functionAssociations = new InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorFunctionAssociationGetArgs>());
            set => _functionAssociations = value;
        }

        [Input("lambdaFunctionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorLambdaFunctionAssociationGetArgs>? _lambdaFunctionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorLambdaFunctionAssociationGetArgs> LambdaFunctionAssociations
        {
            get => _lambdaFunctionAssociations ?? (_lambdaFunctionAssociations = new InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorLambdaFunctionAssociationGetArgs>());
        ...
        public AwsCloudfrontDistributionV2OrderedCacheBehaviorGetArgs()
        {
        }
        public static new AwsCloudfrontDistributionV2OrderedCacheBehaviorGetArgs Empty => new AwsCloudfrontDistributionV2OrderedCacheBehaviorGetArgs();
    }
}

...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sJobSpecGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("selector")]
        public Input<Inputs.K8sJobSpecSelectorGetArgs>? Selector { get; set; }

        /// <summary>
        /// Describes the pod that will be created when executing a job. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/
        /// </summary>
        [Input("template", required: true)]
        public Input<Inputs.K8sJobSpecTemplateGetArgs> Template { get; set; } = null!;
        ...
        public K8sJobSpecGetArgs()
        {
        }
        public static new K8sJobSpecGetArgs Empty => new K8sJobSpecGetArgs();
    }
}

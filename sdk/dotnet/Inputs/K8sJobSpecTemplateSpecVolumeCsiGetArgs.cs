...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sJobSpecTemplateSpecVolumeCsiGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeCsiNodePublishSecretRefGetArgs>? NodePublishSecretRef { get; set; }
        ...
        public K8sJobSpecTemplateSpecVolumeCsiGetArgs()
        {
        }
        public static new K8sJobSpecTemplateSpecVolumeCsiGetArgs Empty => new K8sJobSpecTemplateSpecVolumeCsiGetArgs();
    }
}

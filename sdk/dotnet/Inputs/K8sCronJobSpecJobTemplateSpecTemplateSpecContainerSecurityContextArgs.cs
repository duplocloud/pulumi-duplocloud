...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sCronJobSpecJobTemplateSpecTemplateSpecContainerSecurityContextArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capabilities")]
        public Input<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecContainerSecurityContextCapabilitiesArgs>? Capabilities { get; set; }
        ...
        public Input<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecContainerSecurityContextSeLinuxOptionsArgs>? SeLinuxOptions { get; set; }

        /// <summary>
        /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        [Input("seccompProfile")]
        public Input<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecContainerSecurityContextSeccompProfileArgs>? SeccompProfile { get; set; }

        public K8sCronJobSpecJobTemplateSpecTemplateSpecContainerSecurityContextArgs()
        {
        }
        public static new K8sCronJobSpecJobTemplateSpecTemplateSpecContainerSecurityContextArgs Empty => new K8sCronJobSpecJobTemplateSpecTemplateSpecContainerSecurityContextArgs();
    }
}

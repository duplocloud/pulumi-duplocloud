...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class K8sDaemonSetSpecTemplateSpecContainerSecurityContextGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capabilities")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecContainerSecurityContextCapabilitiesGetArgs>? Capabilities { get; set; }
        ...
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecContainerSecurityContextSeLinuxOptionsGetArgs>? SeLinuxOptions { get; set; }

        /// <summary>
        /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        [Input("seccompProfile")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecContainerSecurityContextSeccompProfileGetArgs>? SeccompProfile { get; set; }

        public K8sDaemonSetSpecTemplateSpecContainerSecurityContextGetArgs()
        {
        }
        public static new K8sDaemonSetSpecTemplateSpecContainerSecurityContextGetArgs Empty => new K8sDaemonSetSpecTemplateSpecContainerSecurityContextGetArgs();
    }
}

...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class K8sDaemonSetSpecTemplateSpecInitContainerGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("args")]
        ...
        [Input("envFroms")]
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerEnvFromGetArgs>? _envFroms;
        ...
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerEnvFromGetArgs> EnvFroms
        {
            get => _envFroms ?? (_envFroms = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerEnvFromGetArgs>());
            set => _envFroms = value;
        }

        [Input("envs")]
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerEnvGetArgs>? _envs;

        /// <summary>
        /// List of environment variables to set in the container. Cannot be updated.
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerEnvGetArgs> Envs
        {
            get => _envs ?? (_envs = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerEnvGetArgs>());
            set => _envs = value;
        }
        ...
        /// </summary>
        [Input("lifecycle")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerLifecycleGetArgs>? Lifecycle { get; set; }

        /// <summary>
        /// Periodic probe of container liveness. Container will be restarted if the probe fails. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#container-probes
        /// </summary>
        [Input("livenessProbe")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerLivenessProbeGetArgs>? LivenessProbe { get; set; }
        ...
        [Input("ports")]
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerPortGetArgs>? _ports;

        /// <summary>
        /// List of ports to expose from the container. Exposing a port here gives the system additional information about the network connections a container uses, but is primarily informational. Not specifying a port here DOES NOT prevent that port from being exposed. Any port which is listening on the default "0.0.0.0" address inside a container will be accessible from the network. Cannot be updated.
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerPortGetArgs> Ports
        {
            get => _ports ?? (_ports = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerPortGetArgs>());
            set => _ports = value;
        }
        ...
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerReadinessProbeGetArgs>? ReadinessProbe { get; set; }

        /// <summary>
        /// Compute Resources required by this container. Cannot be updated. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources
        /// </summary>
        [Input("resources")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerResourcesGetArgs>? Resources { get; set; }
        ...
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextGetArgs>? SecurityContext { get; set; }

        /// <summary>
        /// StartupProbe indicates that the Pod has successfully initialized. If specified, no other probes are executed until this completes successfully. If this probe fails, the Pod will be restarted, just as if the livenessProbe failed. This can be used to provide different probe parameters at the beginning of a Pod's lifecycle, when it might take a long time to load data or warm a cache, than during steady-state operation. This cannot be updated. This is an alpha feature enabled by the StartupProbe feature flag. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
        /// </summary>
        [Input("startupProbe")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerStartupProbeGetArgs>? StartupProbe { get; set; }
        ...
        [Input("volumeMounts")]
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerVolumeMountGetArgs>? _volumeMounts;

        /// <summary>
        /// Pod volumes to mount into the container's filesystem. Cannot be updated.
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerVolumeMountGetArgs> VolumeMounts
        {
            get => _volumeMounts ?? (_volumeMounts = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerVolumeMountGetArgs>());
        ...
        public K8sDaemonSetSpecTemplateSpecInitContainerGetArgs()
        {
        }
        public static new K8sDaemonSetSpecTemplateSpecInitContainerGetArgs Empty => new K8sDaemonSetSpecTemplateSpecInitContainerGetArgs();
    }
}

...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class K8sDaemonSetSpecGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.K8sDaemonSetSpecSelectorGetArgs> Selector { get; set; } = null!;
        ...
        public Input<Inputs.K8sDaemonSetSpecTemplateGetArgs> Template { get; set; } = null!;

        /// <summary>
        /// An update strategy to replace existing DaemonSet pods with new pods.
        /// </summary>
        [Input("updateStrategy")]
        public Input<Inputs.K8sDaemonSetSpecUpdateStrategyGetArgs>? UpdateStrategy { get; set; }

        public K8sDaemonSetSpecGetArgs()
        {
        }
        public static new K8sDaemonSetSpecGetArgs Empty => new K8sDaemonSetSpecGetArgs();
    }
}

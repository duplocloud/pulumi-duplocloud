...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class K8sDaemonSetSpecTemplateSpecContainerEnvArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("valueFrom")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecContainerEnvValueFromArgs>? ValueFrom { get; set; }

        public K8sDaemonSetSpecTemplateSpecContainerEnvArgs()
        {
        }
        public static new K8sDaemonSetSpecTemplateSpecContainerEnvArgs Empty => new K8sDaemonSetSpecTemplateSpecContainerEnvArgs();
    }
}

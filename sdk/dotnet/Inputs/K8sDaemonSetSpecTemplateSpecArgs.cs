...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class K8sDaemonSetSpecTemplateSpecArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("affinity")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecAffinityArgs>? Affinity { get; set; }
        ...
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecContainerArgs>? _containers;
        ...
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecContainerArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecContainerArgs>());
        ...
        /// </summary>
        [Input("dnsConfig")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecDnsConfigArgs>? DnsConfig { get; set; }
        ...
        [Input("hostAliases")]
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecHostAliasArgs>? _hostAliases;

        /// <summary>
        /// List of hosts and IPs that will be injected into the pod's hosts file if specified. Optional: Defaults to empty.
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecHostAliasArgs> HostAliases
        {
            get => _hostAliases ?? (_hostAliases = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecHostAliasArgs>());
        ...
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecImagePullSecretArgs>? _imagePullSecrets;

        /// <summary>
        /// ImagePullSecrets is an optional list of references to secrets in the same namespace to use for pulling any of the images used by this PodSpec. If specified, these secrets will be passed to individual puller implementations for them to use. For example, in the case of docker, only DockerConfig type secrets are honored. More info: https://kubernetes.io/docs/concepts/containers/images/#specifying-imagepullsecrets-on-a-pod
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecImagePullSecretArgs> ImagePullSecrets
        {
            get => _imagePullSecrets ?? (_imagePullSecrets = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecImagePullSecretArgs>());
            set => _imagePullSecrets = value;
        }

        [Input("initContainers")]
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerArgs>? _initContainers;
        ...
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerArgs> InitContainers
        {
            get => _initContainers ?? (_initContainers = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerArgs>());
        ...
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecReadinessGateArgs>? _readinessGates;

        /// <summary>
        /// If specified, all readiness gates will be evaluated for pod readiness. A pod is ready when all its containers are ready AND all conditions specified in the readiness gates have status equal to "True" More info: https://git.k8s.io/enhancements/keps/sig-network/0007-pod-ready%2B%2B.md
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecReadinessGateArgs> ReadinessGates
        {
            get => _readinessGates ?? (_readinessGates = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecReadinessGateArgs>());
        ...
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecSecurityContextArgs>? SecurityContext { get; set; }
        ...
        [Input("tolerations")]
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecTolerationArgs>? _tolerations;

        /// <summary>
        /// If specified, the pod's toleration. Optional: Defaults to empty
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecTolerationArgs> Tolerations
        {
            get => _tolerations ?? (_tolerations = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecTolerationArgs>());
            set => _tolerations = value;
        }

        [Input("topologySpreadConstraints")]
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecTopologySpreadConstraintArgs>? _topologySpreadConstraints;
        ...
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecTopologySpreadConstraintArgs> TopologySpreadConstraints
        {
            get => _topologySpreadConstraints ?? (_topologySpreadConstraints = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecTopologySpreadConstraintArgs>());
            set => _topologySpreadConstraints = value;
        }

        [Input("volumes")]
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecVolumeArgs>? _volumes;

        /// <summary>
        /// List of volumes that can be mounted by containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecVolumeArgs> Volumes
        {
            get => _volumes ?? (_volumes = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecVolumeArgs>());
            set => _volumes = value;
        }

        public K8sDaemonSetSpecTemplateSpecArgs()
        {
        }
        public static new K8sDaemonSetSpecTemplateSpecArgs Empty => new K8sDaemonSetSpecTemplateSpecArgs();
    }
}

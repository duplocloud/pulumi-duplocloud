...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capabilities")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextCapabilitiesGetArgs>? Capabilities { get; set; }
        ...
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptionsGetArgs>? SeLinuxOptions { get; set; }

        /// <summary>
        /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        [Input("seccompProfile")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextSeccompProfileGetArgs>? SeccompProfile { get; set; }

        public K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextGetArgs()
        {
        }
        public static new K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextGetArgs Empty => new K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextGetArgs();
    }
}

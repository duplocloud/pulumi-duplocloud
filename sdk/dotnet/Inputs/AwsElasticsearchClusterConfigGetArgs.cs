...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class AwsElasticsearchClusterConfigGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("coldStorageOptions")]
        public Input<Inputs.AwsElasticsearchClusterConfigColdStorageOptionsGetArgs>? ColdStorageOptions { get; set; }
        ...
        public AwsElasticsearchClusterConfigGetArgs()
        {
        }
        public static new AwsElasticsearchClusterConfigGetArgs Empty => new AwsElasticsearchClusterConfigGetArgs();
    }
}

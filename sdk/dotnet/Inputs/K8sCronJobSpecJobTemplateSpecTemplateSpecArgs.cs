...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sCronJobSpecJobTemplateSpecTemplateSpecArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("affinity")]
        public Input<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecAffinityArgs>? Affinity { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecContainerArgs>? _containers;
        ...
        /// </summary>
        public InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecContainerArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecContainerArgs>());
        ...
        /// </summary>
        [Input("dnsConfig")]
        public Input<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecDnsConfigArgs>? DnsConfig { get; set; }
        ...
        [Input("hostAliases")]
        private InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecHostAliasArgs>? _hostAliases;

        /// <summary>
        /// List of hosts and IPs that will be injected into the pod's hosts file if specified. Optional: Defaults to empty.
        /// </summary>
        public InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecHostAliasArgs> HostAliases
        {
            get => _hostAliases ?? (_hostAliases = new InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecHostAliasArgs>());
        ...
        private InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecImagePullSecretArgs>? _imagePullSecrets;

        /// <summary>
        /// ImagePullSecrets is an optional list of references to secrets in the same namespace to use for pulling any of the images used by this PodSpec. If specified, these secrets will be passed to individual puller implementations for them to use. For example, in the case of docker, only DockerConfig type secrets are honored. More info: https://kubernetes.io/docs/concepts/containers/images/#specifying-imagepullsecrets-on-a-pod
        /// </summary>
        public InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecImagePullSecretArgs> ImagePullSecrets
        {
            get => _imagePullSecrets ?? (_imagePullSecrets = new InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecImagePullSecretArgs>());
            set => _imagePullSecrets = value;
        }

        [Input("initContainers")]
        private InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecInitContainerArgs>? _initContainers;
        ...
        /// </summary>
        public InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecInitContainerArgs> InitContainers
        {
            get => _initContainers ?? (_initContainers = new InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecInitContainerArgs>());
        ...
        private InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecReadinessGateArgs>? _readinessGates;

        /// <summary>
        /// If specified, all readiness gates will be evaluated for pod readiness. A pod is ready when all its containers are ready AND all conditions specified in the readiness gates have status equal to "True" More info: https://git.k8s.io/enhancements/keps/sig-network/0007-pod-ready%2B%2B.md
        /// </summary>
        public InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecReadinessGateArgs> ReadinessGates
        {
            get => _readinessGates ?? (_readinessGates = new InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecReadinessGateArgs>());
        ...
        public Input<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecSecurityContextArgs>? SecurityContext { get; set; }
        ...
        [Input("tolerations")]
        private InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecTolerationArgs>? _tolerations;

        /// <summary>
        /// If specified, the pod's toleration. Optional: Defaults to empty
        /// </summary>
        public InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecTolerationArgs> Tolerations
        {
            get => _tolerations ?? (_tolerations = new InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecTolerationArgs>());
            set => _tolerations = value;
        }

        [Input("topologySpreadConstraints")]
        private InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraintArgs>? _topologySpreadConstraints;
        ...
        /// </summary>
        public InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraintArgs> TopologySpreadConstraints
        {
            get => _topologySpreadConstraints ?? (_topologySpreadConstraints = new InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraintArgs>());
            set => _topologySpreadConstraints = value;
        }

        [Input("volumes")]
        private InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecVolumeArgs>? _volumes;

        /// <summary>
        /// List of volumes that can be mounted by containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes
        /// </summary>
        public InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecVolumeArgs> Volumes
        {
            get => _volumes ?? (_volumes = new InputList<Inputs.K8sCronJobSpecJobTemplateSpecTemplateSpecVolumeArgs>());
            set => _volumes = value;
        }

        public K8sCronJobSpecJobTemplateSpecTemplateSpecArgs()
        {
        }
        public static new K8sCronJobSpecJobTemplateSpecTemplateSpecArgs Empty => new K8sCronJobSpecJobTemplateSpecTemplateSpecArgs();
    }
}

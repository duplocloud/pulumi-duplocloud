...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sJobSpecTemplateSpecVolumeArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeAwsElasticBlockStoreArgs>? AwsElasticBlockStore { get; set; }

        /// <summary>
        /// Represents an Azure Data Disk mount on the host and bind mount to the pod.
        /// </summary>
        [Input("azureDisk")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeAzureDiskArgs>? AzureDisk { get; set; }

        /// <summary>
        /// Represents an Azure File Service mount on the host and bind mount to the pod.
        /// </summary>
        [Input("azureFile")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeAzureFileArgs>? AzureFile { get; set; }

        /// <summary>
        /// Represents a Ceph FS mount on the host that shares a pod's lifetime
        /// </summary>
        [Input("cephFs")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeCephFsArgs>? CephFs { get; set; }
        ...
        /// </summary>
        [Input("cinder")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeCinderArgs>? Cinder { get; set; }

        /// <summary>
        /// ConfigMap represents a configMap that should populate this volume
        /// </summary>
        [Input("configMap")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeConfigMapArgs>? ConfigMap { get; set; }

        /// <summary>
        /// Represents a CSI Volume. More info: https://kubernetes.io/docs/concepts/storage/volumes#csi
        /// </summary>
        [Input("csi")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeCsiArgs>? Csi { get; set; }

        /// <summary>
        /// DownwardAPI represents downward API about the pod that should populate this volume
        /// </summary>
        [Input("downwardApi")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeDownwardApiArgs>? DownwardApi { get; set; }

        /// <summary>
        /// EmptyDir represents a temporary directory that shares a pod's lifetime. More info: https://kubernetes.io/docs/concepts/storage/volumes#emptydir
        /// </summary>
        [Input("emptyDir")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeEmptyDirArgs>? EmptyDir { get; set; }
        ...
        /// </summary>
        [Input("ephemeral")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeEphemeralArgs>? Ephemeral { get; set; }

        /// <summary>
        /// Represents a Fibre Channel resource that is attached to a kubelet's host machine and then exposed to the pod.
        /// </summary>
        [Input("fc")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeFcArgs>? Fc { get; set; }
        ...
        /// </summary>
        [Input("flexVolume")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeFlexVolumeArgs>? FlexVolume { get; set; }
        ...
        /// </summary>
        [Input("flocker")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeFlockerArgs>? Flocker { get; set; }
        ...
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeGcePersistentDiskArgs>? GcePersistentDisk { get; set; }

        /// <summary>
        /// GitRepo represents a git repository at a particular revision.
        /// </summary>
        [Input("gitRepo")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeGitRepoArgs>? GitRepo { get; set; }
        ...
        /// </summary>
        [Input("glusterfs")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeGlusterfsArgs>? Glusterfs { get; set; }
        ...
        /// </summary>
        [Input("hostPath")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeHostPathArgs>? HostPath { get; set; }
        ...
        /// </summary>
        [Input("iscsi")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeIscsiArgs>? Iscsi { get; set; }
        ...
        /// </summary>
        [Input("local")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeLocalArgs>? Local { get; set; }
        ...
        /// </summary>
        [Input("nfs")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeNfsArgs>? Nfs { get; set; }

        /// <summary>
        /// The specification of a persistent volume.
        /// </summary>
        [Input("persistentVolumeClaim")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumePersistentVolumeClaimArgs>? PersistentVolumeClaim { get; set; }

        /// <summary>
        /// Represents a PhotonController persistent disk attached and mounted on kubelets host machine
        /// </summary>
        [Input("photonPersistentDisk")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumePhotonPersistentDiskArgs>? PhotonPersistentDisk { get; set; }
        ...
        /// </summary>
        [Input("projected")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeProjectedArgs>? Projected { get; set; }

        /// <summary>
        /// Quobyte represents a Quobyte mount on the host that shares a pod's lifetime
        /// </summary>
        [Input("quobyte")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeQuobyteArgs>? Quobyte { get; set; }
        ...
        /// </summary>
        [Input("rbd")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeRbdArgs>? Rbd { get; set; }
        ...
        /// </summary>
        [Input("secret")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeSecretArgs>? Secret { get; set; }

        /// <summary>
        /// Represents a vSphere volume attached and mounted on kubelets host machine
        /// </summary>
        [Input("vsphereVolume")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeVsphereVolumeArgs>? VsphereVolume { get; set; }

        public K8sJobSpecTemplateSpecVolumeArgs()
        {
        }
        public static new K8sJobSpecTemplateSpecVolumeArgs Empty => new K8sJobSpecTemplateSpecVolumeArgs();
    }
}

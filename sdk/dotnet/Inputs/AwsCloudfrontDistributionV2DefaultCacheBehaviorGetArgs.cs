...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class AwsCloudfrontDistributionV2DefaultCacheBehaviorGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorForwardedValuesGetArgs>? ForwardedValues { get; set; }

        [Input("functionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorFunctionAssociationGetArgs>? _functionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorFunctionAssociationGetArgs> FunctionAssociations
        {
            get => _functionAssociations ?? (_functionAssociations = new InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorFunctionAssociationGetArgs>());
            set => _functionAssociations = value;
        }

        [Input("lambdaFunctionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorLambdaFunctionAssociationGetArgs>? _lambdaFunctionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorLambdaFunctionAssociationGetArgs> LambdaFunctionAssociations
        {
            get => _lambdaFunctionAssociations ?? (_lambdaFunctionAssociations = new InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorLambdaFunctionAssociationGetArgs>());
        ...
        public AwsCloudfrontDistributionV2DefaultCacheBehaviorGetArgs()
        {
        }
        public static new AwsCloudfrontDistributionV2DefaultCacheBehaviorGetArgs Empty => new AwsCloudfrontDistributionV2DefaultCacheBehaviorGetArgs();
    }
}

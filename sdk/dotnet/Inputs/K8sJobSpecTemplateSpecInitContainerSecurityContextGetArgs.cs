...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sJobSpecTemplateSpecInitContainerSecurityContextGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capabilities")]
        public Input<Inputs.K8sJobSpecTemplateSpecInitContainerSecurityContextCapabilitiesGetArgs>? Capabilities { get; set; }
        ...
        public Input<Inputs.K8sJobSpecTemplateSpecInitContainerSecurityContextSeLinuxOptionsGetArgs>? SeLinuxOptions { get; set; }

        /// <summary>
        /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        [Input("seccompProfile")]
        public Input<Inputs.K8sJobSpecTemplateSpecInitContainerSecurityContextSeccompProfileGetArgs>? SeccompProfile { get; set; }

        public K8sJobSpecTemplateSpecInitContainerSecurityContextGetArgs()
        {
        }
        public static new K8sJobSpecTemplateSpecInitContainerSecurityContextGetArgs Empty => new K8sJobSpecTemplateSpecInitContainerSecurityContextGetArgs();
    }
}

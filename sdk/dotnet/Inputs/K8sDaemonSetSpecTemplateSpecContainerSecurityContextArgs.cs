...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class K8sDaemonSetSpecTemplateSpecContainerSecurityContextArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capabilities")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecContainerSecurityContextCapabilitiesArgs>? Capabilities { get; set; }
        ...
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecContainerSecurityContextSeLinuxOptionsArgs>? SeLinuxOptions { get; set; }

        /// <summary>
        /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        [Input("seccompProfile")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecContainerSecurityContextSeccompProfileArgs>? SeccompProfile { get; set; }

        public K8sDaemonSetSpecTemplateSpecContainerSecurityContextArgs()
        {
        }
        public static new K8sDaemonSetSpecTemplateSpecContainerSecurityContextArgs Empty => new K8sDaemonSetSpecTemplateSpecContainerSecurityContextArgs();
    }
}

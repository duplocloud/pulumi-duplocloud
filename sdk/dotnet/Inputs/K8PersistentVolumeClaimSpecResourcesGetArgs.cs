...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8PersistentVolumeClaimSpecResourcesGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("limits")]
        ...
        public K8PersistentVolumeClaimSpecResourcesGetArgs()
        {
        }
        public static new K8PersistentVolumeClaimSpecResourcesGetArgs Empty => new K8PersistentVolumeClaimSpecResourcesGetArgs();
    }
}

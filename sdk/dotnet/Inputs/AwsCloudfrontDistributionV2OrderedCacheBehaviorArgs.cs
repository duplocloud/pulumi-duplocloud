...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class AwsCloudfrontDistributionV2OrderedCacheBehaviorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorForwardedValuesArgs>? ForwardedValues { get; set; }

        [Input("functionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorFunctionAssociationArgs>? _functionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorFunctionAssociationArgs> FunctionAssociations
        {
            get => _functionAssociations ?? (_functionAssociations = new InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorFunctionAssociationArgs>());
            set => _functionAssociations = value;
        }

        [Input("lambdaFunctionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorLambdaFunctionAssociationArgs>? _lambdaFunctionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorLambdaFunctionAssociationArgs> LambdaFunctionAssociations
        {
            get => _lambdaFunctionAssociations ?? (_lambdaFunctionAssociations = new InputList<Inputs.AwsCloudfrontDistributionV2OrderedCacheBehaviorLambdaFunctionAssociationArgs>());
        ...
        public AwsCloudfrontDistributionV2OrderedCacheBehaviorArgs()
        {
        }
        public static new AwsCloudfrontDistributionV2OrderedCacheBehaviorArgs Empty => new AwsCloudfrontDistributionV2OrderedCacheBehaviorArgs();
    }
}

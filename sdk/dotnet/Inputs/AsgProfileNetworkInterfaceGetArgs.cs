...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class AsgProfileNetworkInterfaceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("metadatas")]
        private InputList<Inputs.AsgProfileNetworkInterfaceMetadataGetArgs>? _metadatas;
        public InputList<Inputs.AsgProfileNetworkInterfaceMetadataGetArgs> Metadatas
        {
            get => _metadatas ?? (_metadatas = new InputList<Inputs.AsgProfileNetworkInterfaceMetadataGetArgs>());
        ...
        public AsgProfileNetworkInterfaceGetArgs()
        {
        }
        public static new AsgProfileNetworkInterfaceGetArgs Empty => new AsgProfileNetworkInterfaceGetArgs();
    }
}

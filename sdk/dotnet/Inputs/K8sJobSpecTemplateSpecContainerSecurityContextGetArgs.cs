...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sJobSpecTemplateSpecContainerSecurityContextGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capabilities")]
        public Input<Inputs.K8sJobSpecTemplateSpecContainerSecurityContextCapabilitiesGetArgs>? Capabilities { get; set; }
        ...
        public Input<Inputs.K8sJobSpecTemplateSpecContainerSecurityContextSeLinuxOptionsGetArgs>? SeLinuxOptions { get; set; }

        /// <summary>
        /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        [Input("seccompProfile")]
        public Input<Inputs.K8sJobSpecTemplateSpecContainerSecurityContextSeccompProfileGetArgs>? SeccompProfile { get; set; }

        public K8sJobSpecTemplateSpecContainerSecurityContextGetArgs()
        {
        }
        public static new K8sJobSpecTemplateSpecContainerSecurityContextGetArgs Empty => new K8sJobSpecTemplateSpecContainerSecurityContextGetArgs();
    }
}

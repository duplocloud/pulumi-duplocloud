...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sCronJobSpecArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.K8sCronJobSpecJobTemplateArgs> JobTemplate { get; set; } = null!;
        ...
        public K8sCronJobSpecArgs()
        {
        }
        public static new K8sCronJobSpecArgs Empty => new K8sCronJobSpecArgs();
    }
}

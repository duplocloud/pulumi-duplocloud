...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class AsgProfileNetworkInterfaceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("metadatas")]
        private InputList<Inputs.AsgProfileNetworkInterfaceMetadataArgs>? _metadatas;
        public InputList<Inputs.AsgProfileNetworkInterfaceMetadataArgs> Metadatas
        {
            get => _metadatas ?? (_metadatas = new InputList<Inputs.AsgProfileNetworkInterfaceMetadataArgs>());
        ...
        public AsgProfileNetworkInterfaceArgs()
        {
        }
        public static new AsgProfileNetworkInterfaceArgs Empty => new AsgProfileNetworkInterfaceArgs();
    }
}

...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sCronJobSpecJobTemplateSpecArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("selector")]
        public Input<Inputs.K8sCronJobSpecJobTemplateSpecSelectorArgs>? Selector { get; set; }

        /// <summary>
        /// Describes the pod that will be created when executing a job. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/
        /// </summary>
        [Input("template", required: true)]
        public Input<Inputs.K8sCronJobSpecJobTemplateSpecTemplateArgs> Template { get; set; } = null!;
        ...
        public K8sCronJobSpecJobTemplateSpecArgs()
        {
        }
        public static new K8sCronJobSpecJobTemplateSpecArgs Empty => new K8sCronJobSpecJobTemplateSpecArgs();
    }
}

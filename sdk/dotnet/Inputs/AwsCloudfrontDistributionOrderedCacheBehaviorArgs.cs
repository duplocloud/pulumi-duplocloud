...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class AwsCloudfrontDistributionOrderedCacheBehaviorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorForwardedValuesArgs>? ForwardedValues { get; set; }

        [Input("functionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorFunctionAssociationArgs>? _functionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorFunctionAssociationArgs> FunctionAssociations
        {
            get => _functionAssociations ?? (_functionAssociations = new InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorFunctionAssociationArgs>());
            set => _functionAssociations = value;
        }

        [Input("lambdaFunctionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociationArgs>? _lambdaFunctionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociationArgs> LambdaFunctionAssociations
        {
            get => _lambdaFunctionAssociations ?? (_lambdaFunctionAssociations = new InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociationArgs>());
        ...
        public AwsCloudfrontDistributionOrderedCacheBehaviorArgs()
        {
        }
        public static new AwsCloudfrontDistributionOrderedCacheBehaviorArgs Empty => new AwsCloudfrontDistributionOrderedCacheBehaviorArgs();
    }
}

...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class K8sDaemonSetSpecTemplateSpecSecurityContextArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecSecurityContextSeLinuxOptionsArgs>? SeLinuxOptions { get; set; }

        /// <summary>
        /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        [Input("seccompProfile")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecSecurityContextSeccompProfileArgs>? SeccompProfile { get; set; }
        ...
        [Input("sysctls")]
        private InputList<Inputs.K8sDaemonSetSpecTemplateSpecSecurityContextSysctlArgs>? _sysctls;

        /// <summary>
        /// holds a list of namespaced sysctls used for the pod.
        /// </summary>
        public InputList<Inputs.K8sDaemonSetSpecTemplateSpecSecurityContextSysctlArgs> Sysctls
        {
            get => _sysctls ?? (_sysctls = new InputList<Inputs.K8sDaemonSetSpecTemplateSpecSecurityContextSysctlArgs>());
            set => _sysctls = value;
        }

        public K8sDaemonSetSpecTemplateSpecSecurityContextArgs()
        {
        }
        public static new K8sDaemonSetSpecTemplateSpecSecurityContextArgs Empty => new K8sDaemonSetSpecTemplateSpecSecurityContextArgs();
    }
}

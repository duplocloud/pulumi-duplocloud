...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class AwsCloudfrontDistributionV2DefaultCacheBehaviorForwardedValuesArgs : global::Pulumi.ResourceArgs
    {
        [Input("cookies", required: true)]
        public Input<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorForwardedValuesCookiesArgs> Cookies { get; set; } = null!;
        ...
        public AwsCloudfrontDistributionV2DefaultCacheBehaviorForwardedValuesArgs()
        {
        }
        public static new AwsCloudfrontDistributionV2DefaultCacheBehaviorForwardedValuesArgs Empty => new AwsCloudfrontDistributionV2DefaultCacheBehaviorForwardedValuesArgs();
    }
}

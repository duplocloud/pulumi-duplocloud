...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sJobSpecTemplateSpecSecurityContextArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.K8sJobSpecTemplateSpecSecurityContextSeLinuxOptionsArgs>? SeLinuxOptions { get; set; }

        /// <summary>
        /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        [Input("seccompProfile")]
        public Input<Inputs.K8sJobSpecTemplateSpecSecurityContextSeccompProfileArgs>? SeccompProfile { get; set; }
        ...
        [Input("sysctls")]
        private InputList<Inputs.K8sJobSpecTemplateSpecSecurityContextSysctlArgs>? _sysctls;

        /// <summary>
        /// holds a list of namespaced sysctls used for the pod.
        /// </summary>
        public InputList<Inputs.K8sJobSpecTemplateSpecSecurityContextSysctlArgs> Sysctls
        {
            get => _sysctls ?? (_sysctls = new InputList<Inputs.K8sJobSpecTemplateSpecSecurityContextSysctlArgs>());
            set => _sysctls = value;
        }

        public K8sJobSpecTemplateSpecSecurityContextArgs()
        {
        }
        public static new K8sJobSpecTemplateSpecSecurityContextArgs Empty => new K8sJobSpecTemplateSpecSecurityContextArgs();
    }
}

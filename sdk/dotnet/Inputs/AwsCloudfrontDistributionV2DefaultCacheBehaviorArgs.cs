...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class AwsCloudfrontDistributionV2DefaultCacheBehaviorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorForwardedValuesArgs>? ForwardedValues { get; set; }

        [Input("functionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorFunctionAssociationArgs>? _functionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorFunctionAssociationArgs> FunctionAssociations
        {
            get => _functionAssociations ?? (_functionAssociations = new InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorFunctionAssociationArgs>());
            set => _functionAssociations = value;
        }

        [Input("lambdaFunctionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorLambdaFunctionAssociationArgs>? _lambdaFunctionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorLambdaFunctionAssociationArgs> LambdaFunctionAssociations
        {
            get => _lambdaFunctionAssociations ?? (_lambdaFunctionAssociations = new InputList<Inputs.AwsCloudfrontDistributionV2DefaultCacheBehaviorLambdaFunctionAssociationArgs>());
        ...
        public AwsCloudfrontDistributionV2DefaultCacheBehaviorArgs()
        {
        }
        public static new AwsCloudfrontDistributionV2DefaultCacheBehaviorArgs Empty => new AwsCloudfrontDistributionV2DefaultCacheBehaviorArgs();
    }
}

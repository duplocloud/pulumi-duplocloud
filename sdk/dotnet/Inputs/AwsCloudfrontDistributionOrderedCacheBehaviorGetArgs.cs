...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class AwsCloudfrontDistributionOrderedCacheBehaviorGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorForwardedValuesGetArgs>? ForwardedValues { get; set; }

        [Input("functionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorFunctionAssociationGetArgs>? _functionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorFunctionAssociationGetArgs> FunctionAssociations
        {
            get => _functionAssociations ?? (_functionAssociations = new InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorFunctionAssociationGetArgs>());
            set => _functionAssociations = value;
        }

        [Input("lambdaFunctionAssociations")]
        private InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociationGetArgs>? _lambdaFunctionAssociations;
        public InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociationGetArgs> LambdaFunctionAssociations
        {
            get => _lambdaFunctionAssociations ?? (_lambdaFunctionAssociations = new InputList<Inputs.AwsCloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociationGetArgs>());
        ...
        public AwsCloudfrontDistributionOrderedCacheBehaviorGetArgs()
        {
        }
        public static new AwsCloudfrontDistributionOrderedCacheBehaviorGetArgs Empty => new AwsCloudfrontDistributionOrderedCacheBehaviorGetArgs();
    }
}

...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sJobSpecTemplateSpecContainerSecurityContextArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capabilities")]
        public Input<Inputs.K8sJobSpecTemplateSpecContainerSecurityContextCapabilitiesArgs>? Capabilities { get; set; }
        ...
        public Input<Inputs.K8sJobSpecTemplateSpecContainerSecurityContextSeLinuxOptionsArgs>? SeLinuxOptions { get; set; }

        /// <summary>
        /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        [Input("seccompProfile")]
        public Input<Inputs.K8sJobSpecTemplateSpecContainerSecurityContextSeccompProfileArgs>? SeccompProfile { get; set; }

        public K8sJobSpecTemplateSpecContainerSecurityContextArgs()
        {
        }
        public static new K8sJobSpecTemplateSpecContainerSecurityContextArgs Empty => new K8sJobSpecTemplateSpecContainerSecurityContextArgs();
    }
}

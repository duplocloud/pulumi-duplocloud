...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class K8sDaemonSetMetadataArgs : global::Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        public K8sDaemonSetMetadataArgs()
        {
        }
        public static new K8sDaemonSetMetadataArgs Empty => new K8sDaemonSetMetadataArgs();
    }
}

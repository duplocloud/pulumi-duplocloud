...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sCronJobMetadataGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        public K8sCronJobMetadataGetArgs()
        {
        }
        public static new K8sCronJobMetadataGetArgs Empty => new K8sCronJobMetadataGetArgs();
    }
}

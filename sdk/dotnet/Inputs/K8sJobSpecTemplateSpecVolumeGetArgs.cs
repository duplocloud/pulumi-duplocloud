...
namespace Pulumi.Duplocloud.Inputs
{
    ...
    public sealed class K8sJobSpecTemplateSpecVolumeGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeAwsElasticBlockStoreGetArgs>? AwsElasticBlockStore { get; set; }

        /// <summary>
        /// Represents an Azure Data Disk mount on the host and bind mount to the pod.
        /// </summary>
        [Input("azureDisk")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeAzureDiskGetArgs>? AzureDisk { get; set; }

        /// <summary>
        /// Represents an Azure File Service mount on the host and bind mount to the pod.
        /// </summary>
        [Input("azureFile")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeAzureFileGetArgs>? AzureFile { get; set; }

        /// <summary>
        /// Represents a Ceph FS mount on the host that shares a pod's lifetime
        /// </summary>
        [Input("cephFs")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeCephFsGetArgs>? CephFs { get; set; }
        ...
        /// </summary>
        [Input("cinder")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeCinderGetArgs>? Cinder { get; set; }

        /// <summary>
        /// ConfigMap represents a configMap that should populate this volume
        /// </summary>
        [Input("configMap")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeConfigMapGetArgs>? ConfigMap { get; set; }

        /// <summary>
        /// Represents a CSI Volume. More info: https://kubernetes.io/docs/concepts/storage/volumes#csi
        /// </summary>
        [Input("csi")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeCsiGetArgs>? Csi { get; set; }

        /// <summary>
        /// DownwardAPI represents downward API about the pod that should populate this volume
        /// </summary>
        [Input("downwardApi")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeDownwardApiGetArgs>? DownwardApi { get; set; }

        /// <summary>
        /// EmptyDir represents a temporary directory that shares a pod's lifetime. More info: https://kubernetes.io/docs/concepts/storage/volumes#emptydir
        /// </summary>
        [Input("emptyDir")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeEmptyDirGetArgs>? EmptyDir { get; set; }
        ...
        /// </summary>
        [Input("ephemeral")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeEphemeralGetArgs>? Ephemeral { get; set; }

        /// <summary>
        /// Represents a Fibre Channel resource that is attached to a kubelet's host machine and then exposed to the pod.
        /// </summary>
        [Input("fc")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeFcGetArgs>? Fc { get; set; }
        ...
        /// </summary>
        [Input("flexVolume")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeFlexVolumeGetArgs>? FlexVolume { get; set; }
        ...
        /// </summary>
        [Input("flocker")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeFlockerGetArgs>? Flocker { get; set; }
        ...
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeGcePersistentDiskGetArgs>? GcePersistentDisk { get; set; }

        /// <summary>
        /// GitRepo represents a git repository at a particular revision.
        /// </summary>
        [Input("gitRepo")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeGitRepoGetArgs>? GitRepo { get; set; }
        ...
        /// </summary>
        [Input("glusterfs")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeGlusterfsGetArgs>? Glusterfs { get; set; }
        ...
        /// </summary>
        [Input("hostPath")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeHostPathGetArgs>? HostPath { get; set; }
        ...
        /// </summary>
        [Input("iscsi")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeIscsiGetArgs>? Iscsi { get; set; }
        ...
        /// </summary>
        [Input("local")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeLocalGetArgs>? Local { get; set; }
        ...
        /// </summary>
        [Input("nfs")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeNfsGetArgs>? Nfs { get; set; }

        /// <summary>
        /// The specification of a persistent volume.
        /// </summary>
        [Input("persistentVolumeClaim")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumePersistentVolumeClaimGetArgs>? PersistentVolumeClaim { get; set; }

        /// <summary>
        /// Represents a PhotonController persistent disk attached and mounted on kubelets host machine
        /// </summary>
        [Input("photonPersistentDisk")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumePhotonPersistentDiskGetArgs>? PhotonPersistentDisk { get; set; }
        ...
        /// </summary>
        [Input("projected")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeProjectedGetArgs>? Projected { get; set; }

        /// <summary>
        /// Quobyte represents a Quobyte mount on the host that shares a pod's lifetime
        /// </summary>
        [Input("quobyte")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeQuobyteGetArgs>? Quobyte { get; set; }
        ...
        /// </summary>
        [Input("rbd")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeRbdGetArgs>? Rbd { get; set; }
        ...
        /// </summary>
        [Input("secret")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeSecretGetArgs>? Secret { get; set; }

        /// <summary>
        /// Represents a vSphere volume attached and mounted on kubelets host machine
        /// </summary>
        [Input("vsphereVolume")]
        public Input<Inputs.K8sJobSpecTemplateSpecVolumeVsphereVolumeGetArgs>? VsphereVolume { get; set; }

        public K8sJobSpecTemplateSpecVolumeGetArgs()
        {
        }
        public static new K8sJobSpecTemplateSpecVolumeGetArgs Empty => new K8sJobSpecTemplateSpecVolumeGetArgs();
    }
}

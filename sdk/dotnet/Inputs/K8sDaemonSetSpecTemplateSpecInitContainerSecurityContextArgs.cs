...
namespace DuploCloud.Pulumi.Inputs
{
    ...
    public sealed class K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capabilities")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextCapabilitiesArgs>? Capabilities { get; set; }
        ...
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptionsArgs>? SeLinuxOptions { get; set; }

        /// <summary>
        /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        [Input("seccompProfile")]
        public Input<Inputs.K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextSeccompProfileArgs>? SeccompProfile { get; set; }

        public K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextArgs()
        {
        }
        public static new K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextArgs Empty => new K8sDaemonSetSpecTemplateSpecInitContainerSecurityContextArgs();
    }
}

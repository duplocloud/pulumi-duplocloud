...
namespace Pulumi.Duplocloud.Outputs
{
    ...
    [OutputType]
    public sealed class K8sJobSpecTemplateSpecVolumeFlexVolume
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.K8sJobSpecTemplateSpecVolumeFlexVolumeSecretRef? SecretRef;

        [OutputConstructor]
        private K8sJobSpecTemplateSpecVolumeFlexVolume(
            string driver,
            ...
            Outputs.K8sJobSpecTemplateSpecVolumeFlexVolumeSecretRef? secretRef)
        {
            Driver = driver;
            FsType = fsType;
            Options = options;

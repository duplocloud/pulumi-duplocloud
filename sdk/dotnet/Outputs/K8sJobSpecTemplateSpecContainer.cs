...
namespace DuploCloud.Pulumi.Outputs
{
    ...
    [OutputType]
    public sealed class K8sJobSpecTemplateSpecContainer
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.K8sJobSpecTemplateSpecContainerEnvFrom> EnvFroms;
        /// <summary>
        /// List of environment variables to set in the container. Cannot be updated.
        /// </summary>
        public readonly ImmutableArray<Outputs.K8sJobSpecTemplateSpecContainerEnv> Envs;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.K8sJobSpecTemplateSpecContainerLifecycle? Lifecycle;
        /// <summary>
        /// Periodic probe of container liveness. Container will be restarted if the probe fails. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#container-probes
        /// </summary>
        public readonly Outputs.K8sJobSpecTemplateSpecContainerLivenessProbe? LivenessProbe;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.K8sJobSpecTemplateSpecContainerPort> Ports;
        /// <summary>
        /// Periodic probe of container service readiness. Container will be removed from service endpoints if the probe fails. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#container-probes
        /// </summary>
        public readonly Outputs.K8sJobSpecTemplateSpecContainerReadinessProbe? ReadinessProbe;
        /// <summary>
        /// Compute Resources required by this container. Cannot be updated. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources
        /// </summary>
        public readonly Outputs.K8sJobSpecTemplateSpecContainerResources? Resources;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.K8sJobSpecTemplateSpecContainerSecurityContext? SecurityContext;
        /// <summary>
        /// StartupProbe indicates that the Pod has successfully initialized. If specified, no other probes are executed until this completes successfully. If this probe fails, the Pod will be restarted, just as if the livenessProbe failed. This can be used to provide different probe parameters at the beginning of a Pod's lifecycle, when it might take a long time to load data or warm a cache, than during steady-state operation. This cannot be updated. This is an alpha feature enabled by the StartupProbe feature flag. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
        /// </summary>
        public readonly Outputs.K8sJobSpecTemplateSpecContainerStartupProbe? StartupProbe;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.K8sJobSpecTemplateSpecContainerVolumeMount> VolumeMounts;
        /// <summary>
        ...
        [OutputConstructor]
        private K8sJobSpecTemplateSpecContainer(
            ImmutableArray<string> args,

            ImmutableArray<string> commands,

            ImmutableArray<Outputs.K8sJobSpecTemplateSpecContainerEnvFrom> envFroms,

            ImmutableArray<Outputs.K8sJobSpecTemplateSpecContainerEnv> envs,

            string? image,

            string? imagePullPolicy,

            Outputs.K8sJobSpecTemplateSpecContainerLifecycle? lifecycle,

            Outputs.K8sJobSpecTemplateSpecContainerLivenessProbe? livenessProbe,

            string name,

            ImmutableArray<Outputs.K8sJobSpecTemplateSpecContainerPort> ports,

            Outputs.K8sJobSpecTemplateSpecContainerReadinessProbe? readinessProbe,

            Outputs.K8sJobSpecTemplateSpecContainerResources? resources,

            Outputs.K8sJobSpecTemplateSpecContainerSecurityContext? securityContext,

            Outputs.K8sJobSpecTemplateSpecContainerStartupProbe? startupProbe,
            ...
            ImmutableArray<Outputs.K8sJobSpecTemplateSpecContainerVolumeMount> volumeMounts,

...
namespace Pulumi.Duplocloud.Outputs
{
    ...
    [OutputType]
    public sealed class K8sJobSpecTemplateSpecInitContainerEnv
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.K8sJobSpecTemplateSpecInitContainerEnvValueFrom? ValueFrom;

        [OutputConstructor]
        private K8sJobSpecTemplateSpecInitContainerEnv(
            string name,

            string? value,

            Outputs.K8sJobSpecTemplateSpecInitContainerEnvValueFrom? valueFrom)
        {
            Name = name;
            Value = value;
            ValueFrom = valueFrom;

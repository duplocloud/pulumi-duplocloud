...
namespace DuploCloud.Pulumi.Outputs
{
    ...
    [OutputType]
    public sealed class K8sJobSpecTemplateSpecVolumeProjected
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.K8sJobSpecTemplateSpecVolumeProjectedSource> Sources;

        [OutputConstructor]
        private K8sJobSpecTemplateSpecVolumeProjected(
            string? defaultMode,

            ImmutableArray<Outputs.K8sJobSpecTemplateSpecVolumeProjectedSource> sources)
        {

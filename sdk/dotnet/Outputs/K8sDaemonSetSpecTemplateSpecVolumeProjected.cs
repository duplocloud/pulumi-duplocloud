...
namespace DuploCloud.Pulumi.Outputs
{
    ...
    [OutputType]
    public sealed class K8sDaemonSetSpecTemplateSpecVolumeProjected
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.K8sDaemonSetSpecTemplateSpecVolumeProjectedSource> Sources;

        [OutputConstructor]
        private K8sDaemonSetSpecTemplateSpecVolumeProjected(
            string? defaultMode,

            ImmutableArray<Outputs.K8sDaemonSetSpecTemplateSpecVolumeProjectedSource> sources)
        {

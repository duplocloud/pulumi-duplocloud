...
namespace Pulumi.Duplocloud.Outputs
{
    ...
    [OutputType]
    public sealed class K8sJobSpecTemplateSpecContainerEnv
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.K8sJobSpecTemplateSpecContainerEnvValueFrom? ValueFrom;

        [OutputConstructor]
        private K8sJobSpecTemplateSpecContainerEnv(
            string name,

            string? value,

            Outputs.K8sJobSpecTemplateSpecContainerEnvValueFrom? valueFrom)
        {
            Name = name;
            Value = value;
            ValueFrom = valueFrom;

...
namespace DuploCloud.Pulumi.Outputs
{
    ...
    [OutputType]
    public sealed class K8sDaemonSetSpecTemplateSpecInitContainerEnv
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.K8sDaemonSetSpecTemplateSpecInitContainerEnvValueFrom? ValueFrom;

        [OutputConstructor]
        private K8sDaemonSetSpecTemplateSpecInitContainerEnv(
            string name,

            string? value,

            Outputs.K8sDaemonSetSpecTemplateSpecInitContainerEnvValueFrom? valueFrom)
        {
            Name = name;
            Value = value;
            ValueFrom = valueFrom;
